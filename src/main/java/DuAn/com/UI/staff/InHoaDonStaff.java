 ...
 * @author NITRO 5
 */
public class InHoaDonStaff extends javax.swing.JFrame {
    ImageIcon icon;
    public void doiIcon() {
    ...
    private void lblOrMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblOrMouseClicked
        ...
        try {
            ...
            Logger.getLogger(InHoaDonStaff.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InHoaDonStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InHoaDonStaff().setVisible(true);
            }
        });
    }
